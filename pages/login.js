        ...
        <div className="lg:px-96 lg:ml-28">
            ...
            <div className=" max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 sm:mt-5 lg:mt-10 m-0">
                <form onSubmit={handleSubmit(handleLogin)} className="space-y-6" action="#">
                    <h5 className="text-xl font-medium text-gray-900 dark:text-white text-center">Login</h5>
                    ...
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                        ...
                        Not registered? <Link href="/signup" className="text-blue-700 hover:underline dark:text-blue-500">sign up here</Link>
                    </div>
                </form>
            </div>

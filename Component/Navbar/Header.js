        ...
        <>
            <Navbar className="container lg:mt-3 shadow-lg"
                ...
                <Navbar.Collapse>
                    ...
                    {
                        user?.photoURL ?
                            <><img className="w-10 h-10 rounded-full" src={user.photoURL} title={user?.displayName} alt="picture"></img></>
                            :
                            <><img className="w-10 h-10 rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLxPuR1UwKhFQLeI2FPp2pcwsU97I9VXpD4gvAeH1t-UmGMoU465igKtJfYTPCUqDN4oE&usqp=CAU" title={user?.displayName} alt="picture"></img>
                            </>
                    }
